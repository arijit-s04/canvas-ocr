package com.android.arijit.canvas.ocr.topsheet;
...
public class CustomDragHelper {
     ...
     */
    public static CustomDragHelper create(ViewGroup forParent, Callback cb) {
        return new CustomDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static CustomDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final CustomDragHelper helper = create(forParent, cb);
...
import android.support.v4.view.ViewCompat;   *
     ...
     * @param forParent Parent view to monitor
     */
    private CustomDragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
...
//            Log.d("TAG", "continueSettling: y: " + y);
//            Log.d("TAG", "continueSettling: mCapturedView.getTop(): " + mCapturedView.getTop());
...
//            Log.d("TAG", "continueSettling: dy: " + dy);
