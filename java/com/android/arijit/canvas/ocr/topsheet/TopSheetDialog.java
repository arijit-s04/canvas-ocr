...
import com.android.arijit.canvas.ocr.R;
...
public class TopSheetDialog extends AppCompatDialog {
    ...
    private View wrapInTopSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ...
        topSheetBehavior.setPeekHeight(150);
        if (params == null) {
...
//        }
    ...
    public void toggleSwipe(boolean value) {
        if(topSheetBehavior == null) return;
        topSheetBehavior.setHandleSwipe(value);
    }
